...
- Editer une carte (attention il faudra faire soit même le formulaire)
- Supprimer une carte.
...
- Pour récupérer les données du formualaire, regarde [la doc de FormData](https://developer.mozilla.org/fr/docs/Web/API/FormData).
